...
#     def test_load_default(self, nth):
#         name = 'load_collection_50m'
...
#
#         # insert
#         data = cf.gen_default_list_data(per_nb)[1:3]
#         for i in range(rounds):
#             t0 = datetime.datetime.now()
#             ins_res, res = collection_w.insert(data, timeout=100)
#             tt = datetime.datetime.now() - t0
#             log.debug(f"thread{nth} round{i} insert {per_nb} entities in {tt}s")
